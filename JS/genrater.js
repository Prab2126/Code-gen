...
//all input ,select are selected 
    ...
    let btn_border_radius_top_left=document.querySelector("#border-radius-top-left");
    let btn_border_radius_top_right=document.querySelector("#border-radius-top-right");
    let btn_border_radius_bottom_left=document.querySelector("#border-radius-bottom-right");
    let btn_border_radius_bottom_right=document.querySelector("#border-radius-bottom-left");
    //selected button
...
let Button_Lettergap_preview=document.querySelector(".letter-spacing-preview");
...
let Btn_preview_paddingBottom=document.querySelector(".padding-preview-bottom");
...
let btn_border_preview_type_direction=document.querySelector(".border-preview-type-direction");
let btn_border_preview_color_direction=document.querySelector(".border-preview-color-direction");
...
let btn_preview_border_bottom=document.querySelector(".border-preview-bottom");
...
/// border-radius
let btn_preview_border_radiusAfterALl=document.querySelectorAll(".border-radius-preview ~ span");
let btn_preview_border_radius=document.querySelector(".border-radius-preview");
    let btn_preview_border_radius_top_left=document.querySelector(".border-radius-preview-top-left");
    let btn_preview_border_radius_top_right=document.querySelector(".border-radius-preview-top-right");
    let btn_preview_border_radius_bottom_left=document.querySelector(".border-radius-preview-bottom-left");
    let btn_preview_border_radius_bottom_right=document.querySelector(".border-radius-preview-bottom-right");
...
let [border_top_left_radiusvalue, border_top_right_radiusvalue, 
     border_bottom_left_radiusvalue, border_bottom_right_radiusvalue] = [0, 0, 0, 0];

let FunctionOFBdRadius = () => {
    btn_preview.style.borderRadius = 
    `${border_top_left_radiusvalue}px ${border_top_right_radiusvalue}px 
...
Button_Textcolor_preview.innerHTML=btn_color;
    ...
    let arrayBorder = [btn_border_width_direction, btn_border_type_direction, btn_border_color_direction];
    ...
    let innerHTMLofCustom = [btn_preview_border_top, btn_preview_border_right, btn_preview_border_bottom, btn_preview_border_left];
    innerHTMLofCustom.forEach(value => {
        value.innerHTML = "";
    });
    
    let [bordertopvalue, borderrightvalue, borderbottomvalue, borderleftvalue, borderwidthvalue, bordertypevalue, bordercolorvalue] = [0, 0,0,0, 0, '', ''];
    ...
    function content() {
       ...
       previewbtnDirectionalValue1= btn_preview_border_top.innerHTML = bordertopvalue + "px";
previewbtnDirectionalValue2= btn_preview_border_right.innerHTML = borderrightvalue + "px";
previewbtnDirectionalValue3= btn_preview_border_bottom.innerHTML = borderbottomvalue + "px";
previewbtnDirectionalValue4= btn_preview_border_left.innerHTML = borderleftvalue + "px";
    ...
    let allborder = [btn_preview_border_top, btn_preview_border_right, btn_preview_border_bottom, btn_preview_border_left];
    ...
    btn_borderWidth.addEventListener("input", () => {
        ...
        let allvalueSame = [btn_borderTop, btn_borderRight, btn_borderBottom, btn_borderLeft];
...
btn_padding.addEventListener("input",()=>{
    ...
    let btn_same_paddingOfdirection=document.querySelectorAll(".btn_same_padding");
...
let [btn_inset,BtnaddShadowX,BtnaddShadowY,BtnaddShadowBlur,BtnaddShadowRange,BtnaddShadowColor]=["",0 , 0 , 0 ,0 ,"#ffff"];
function btn_shadow(){
...
let [X_radiusTopRight,X_radiusBottomLeft,Y_radiusTopLeft,Y_radiusBottomRight]=[0,100,0,0];


const borderRadiusImpliment=()=>{
radiusParent.style.borderRadius=`${X_radiusTopRight}% ${100-X_radiusTopRight}% ${100-X_radiusBottomLeft}% ${X_radiusBottomLeft}% / ${100-Y_radiusTopLeft}% ${Y_radiusBottomRight}% ${100-Y_radiusBottomRight}% ${Y_radiusTopLeft}% `;
};

       top_radius.addEventListener("input",()=>{
        let radius=top_radius.value;
        X_radiusTopRight=radius;
        radius_Span_one.forEach(value=>{value.style.display="inline";});
        ...
        radius_Span_three.forEach(value=>{value.style.display="inline";});
        radius_Span_four.forEach(value=>{value.style.display="inline";});
        radius_Span_one.forEach(value=>{value.style.display="inline";});
        radius_Span_two.forEach(value=>{
            value.style.display="inline";
                        })
